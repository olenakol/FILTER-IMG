...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"refs.js":[function(require,module,exports) {
"use strict";
...
class ImageApiService {
  ...
  async getImage(searchQuery) {
    const response = await fetch(`https://pixabay.com/api/?key=24982514-b6b9b361a615e243abfbdf1fa&q=${this.searchQuery}&image_type=photo$safesearch=true&orientation=horizontal&page=${this.page}`);
...
exports.default = ImageApiService;
...
var _default = () => {
  const refs = _refs.default;
  const imageApiPictures = new _service.default();
  const galleryLightbox = new _simplelightbox.default('.cardItem a');
  ...
  const onSearch = e => {
    ...
    imageApiPictures.getImage().then(_ref => {
      let {
        hits,
        totalHits
      } = _ref;
  ...
  const onLoadMore = () => {
    imageApiPictures.getImage().then(_ref2 => {
      let {
        hits
      } = _ref2;
      appendNewCards(hits);
  ...
  const firstTotalHits = totalHits => {
    _notiflixNotifyAio.Notify.success(`Hooray! We found totalHits  ${totalHits} images.`);
  };
...
exports.default = _default;
},{"./refs":"refs.js","./service":"service.js","notiflix/build/notiflix-notify-aio":"../node_modules/notiflix/build/notiflix-notify-aio.js","simplelightbox":"../node_modules/simplelightbox/dist/simple-lightbox.modules.js","simplelightbox/dist/simple-lightbox.min.css":"../node_modules/simplelightbox/dist/simple-lightbox.min.css"}],"index.js":[function(require,module,exports) {
"use strict";
